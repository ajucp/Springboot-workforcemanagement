...
public class InMemoryTaskRepository implements TaskRepository {
    ...
    @Override
    public List<TaskManagement> findByAssigneeIdInAndStartTimeBetween(List<Long> assigneeIds, Long startTime,
            Long endTime) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'findByAssigneeIdInAndStartTimeBetween'");
    }
